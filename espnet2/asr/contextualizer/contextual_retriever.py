...
class LateInteractionXPhoneContextualRetriever(LateInteractionContextualRetriever):
    def __init__(
        ...
        **kwargs
        ...
        self.context_encoder_pho = ContextEncoderXPhone(
            vocab_size=vocab_size,
            hidden_size=context_input_dim,
            output_size=proj_dim,
            num_blocks=2,
        ...
        self.retriever = MultiMaxSimInteractor(
            input_dim=proj_dim,
            proj_dim=interaction_proj_dim,
            dropout=dropout,
    ...
    def forward_context_encoder(
        ...
        **kwargs
        ...
        context_phone, context_phone_ilens = self.context_encoder_pho(
            context_phone, 
            context_phone_ilens
        )
        ...
        if return_mean:
            context_mean_pho, context_phone_ilens
        return (
            context, 
            ilens,
            context_phone,
    ...
    def forward_retriever(
        ...
        **kwargs
        ...
        scores = self.retriever(
            query=query, 
            context_subword=context_subword,
            context_phoneme=context_phone,
        )
        return scores
