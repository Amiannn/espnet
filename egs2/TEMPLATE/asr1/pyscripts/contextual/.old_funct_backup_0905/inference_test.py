...
if __name__ == "__main__":
    ...
    contextual_processor = loader.collate_fn.contextual_processor
    ...
    if contextual_processor.sampling_method is not None:
        contextual_processor.hn_sampler.index = index
    ...
    for data in loader:
        if count >= 1:
            break
        count += 1
        # contextual_processor.hn_sampler.sampler_drop = 0.0
        # result = contextual_processor.hn_sampler.ann_hnw_method(gold_idx=[1, 3, 5])
