...
uttblist_idx_train="uttblist_idx_f1024"
uttblist_idx_valid="uttblist_idx_f1024"
uttblist_idx_test="uttblist_idx"

asr_config=conf/contextual/conformer/gamma/adapter__mediumbatch_f1024_reweight_lp0.9.yaml
inference_config=conf/contextual/conformer/decode_asr_conformer_adapter_bs5.yaml
asr_tag=conformer/adapter__mediumbatch_f1024_reweight_lp0.9
