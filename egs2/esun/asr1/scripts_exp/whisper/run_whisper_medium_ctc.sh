...
asr_config=conf/whisper/train_asr_whisper_ctc.yaml
inference_config=conf/whisper/decode_asr_whisper_noctc_greedy.yaml
asr_tag=whisper_medium_ctc_finetune_lr1e-5_adamw_wd1e-2_3epochs
...
CUDA_VISIBLE_DEVICES=0 ./asr.sh \
    ...
    --pretrained_model "${pretrained_model}:decoder.decoders.token_embedding:ctc.ctc_lo" \
    --lm_fold_length 150 "$@"
