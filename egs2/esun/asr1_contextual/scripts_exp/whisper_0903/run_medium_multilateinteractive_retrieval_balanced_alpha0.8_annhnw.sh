...
asr_tag=whisper/run_medium_multilateinteractive_retrieval_balanced_alpha0.8_annhnw_test

# pretrained_model=../asr1/exp/asr_whisper_medium/0epoch.pth
pretrained_model=./exp/asr_whisper/run_medium_multilateinteractive_retrieval_balanced_alpha0.9_annhnw/89epoch.pth
