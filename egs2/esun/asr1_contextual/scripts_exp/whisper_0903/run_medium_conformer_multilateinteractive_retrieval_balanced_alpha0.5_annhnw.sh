...
asr_config=conf/contextual/whisper/train_asr_whisper_medium_conformer_multilateinteractive_retrieval_balanced_alpha0.5_annhnw.yaml
inference_config=conf/contextual/whisper/decode_asr_whisper_ctc_greedy_c20_k5.yaml
asr_tag=whisper/run_medium_conformer_multilateinteractive_retrieval_balanced_alpha0.5_annhnw
...
pretrained_model=exp/asr_whisper/run_medium_conformer_multilateinteractive_retrieval_suffix/24epoch.pth
