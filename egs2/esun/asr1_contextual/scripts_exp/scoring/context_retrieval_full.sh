...
for folder in "${exp_folder[@]}"; do
    ...
    # Update the exp_path with the current folder
    exp_path="./exp/asr_whisper/${folder}/decode_asr_whisper_contextual_adapter_decoder_c${distractor_len}_entity_earningcall_asr_model_valid.loss.ave_10best_fixed/test"
