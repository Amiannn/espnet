...
asr_config=conf/contextual/whisper/train_asr_whisper_medium_lateinteraction_contextual_retriever.yaml
inference_config=conf/contextual/whisper/decode_asr_whisper_ctc_greedy_c100.yaml
asr_tag=whisper/run_medium_lateinteraction_contextual_retriever
