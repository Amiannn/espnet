...
asr_config=conf/exp/contextual_adapter/train_rnnt_contextual_adapter_tf_xphone_encoder_with_gactc.yaml
inference_config=conf/exp/decode_asr_contextual_rnnt_transducer_greedy.yaml
asr_tag=finetune_freeze_ct_enc_cb_tf_xphone_gactc
