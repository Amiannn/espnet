...
asr_config=conf/contextual_adapter/whisper/tune_base__enc_conv2_xphone__ga_warmup__bigbatch.yaml
inference_config=conf/exp/decode_contextual_whisper_xphone_greedy.yaml
asr_tag=whisper/tune_base__enc_conv2_xphone__ga_warmup__bigbatch_test2
