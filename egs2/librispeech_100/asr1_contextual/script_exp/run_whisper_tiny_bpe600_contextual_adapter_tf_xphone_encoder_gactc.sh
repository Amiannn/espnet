...
asr_config=conf/exp/contextual_adapter/train_whisper_tiny_en_contextual_adapter_tf_xphone_encoder_gactc.yaml
inference_config=conf/exp/decode_contextual_whisper_greedy.yaml
asr_tag=finetune_freeze_whisper_tiny_bpe600_cb_tf_xphone_gactc
