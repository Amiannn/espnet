...
asr_config=conf/contextual_adapter/whisper/train_whisper_tiny_en_encoder_contextual_adapter_encoder.yaml
inference_config=conf/exp/decode_contextual_whisper_encoder_greedy.yaml
asr_tag=finetune_freeze_whisper_tiny_encoder_bpe600_cb_gactc
