...
asr_config=conf/contextual_adapter/whisper/train_whisper_base_contextual_conv_xphone_gated_adapter_encoder_gactc_fixtinytem.yaml
inference_config=conf/exp/decode_contextual_whisper_xphone_greedy.yaml
asr_tag=finetune_freeze_whisper_base_cb_conv_xphone_gated_gactc_fixtinytem
