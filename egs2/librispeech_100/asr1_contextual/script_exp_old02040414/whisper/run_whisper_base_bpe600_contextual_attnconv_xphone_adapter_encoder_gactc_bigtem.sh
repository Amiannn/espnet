...
asr_config=conf/contextual_adapter/whisper/train_whisper_base_en_contextual_attnconv_xphone_adapter_encoder_gactc_bigtem.yaml
inference_config=conf/exp/decode_contextual_whisper_xphone_greedy_small.yaml
asr_tag=finetune_freeze_whisper_base_bpe600_cb_attnconv_xphone_gactc_tem
