...
asr_config=conf/contextual_adapter/conformer/train_conformer_contextual_adapter_encoder_with_gactc_gakl_tem.yaml
inference_config=conf/exp/decode_asr_greedy.yaml
asr_tag=finetune_freeze_con_enc_cb_gactc_gakl_tem
