...
asr_config=conf/contextual_adapter/conformer/train_conformer_contextual_xphone_adapter_encoder_with_gactc_tem.yaml
inference_config=conf/exp/decode_asr_greedy_xphone.yaml
asr_tag=finetune_freeze_con_enc_cb_xphone_gactc_tem
