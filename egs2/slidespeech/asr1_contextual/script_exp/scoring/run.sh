...
# context_type="f10"
# context_path="./dump/raw/test/uttblist_${context_type}"
wav2session="./dump/raw/test/wav2session"
hyp_path="./exp/asr_conformer/run_context_adapter_encoder_drop_suffix/decode_asr_no_contextual_bs3_asr_model_valid.acc.ave_10best/test/text"
