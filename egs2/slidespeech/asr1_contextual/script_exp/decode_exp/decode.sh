...
# inference_configs=( "conf/conformer_new/decode/decode_asr_bs20_ctx_keywords.yaml" )
inference_configs=( "conf/conformer_new/decode/decode_asr_bs20_ctx_keywords_dev.yaml" )

# inference_configs=( "conf/conformer/decode/decode_asr_bs20_ctx_keywords.yaml" \
#                     "conf/conformer/decode/decode_asr_bs20_ctx_non.yaml" \
#                     "conf/conformer/decode/decode_asr_bs20_ctx_keyword50.yaml" \
#                     "conf/conformer/decode/decode_asr_bs10_ctx_keywords.yaml" \
#                     "conf/conformer/decode/decode_asr_bs10_ctx_non.yaml" \
#                     "conf/conformer/decode/decode_asr_bs10_ctx_keyword50.yaml" )

uttblist_idx_tests=( "uttblist_idx_keywords" )
# uttblist_idx_tests=( "uttblist_idx_keywords" "uttblist_idx_f10" "uttblist_idx_keywords" "uttblist_idx_keywords" "uttblist_idx_f10" "uttblist_idx_keywords" )
