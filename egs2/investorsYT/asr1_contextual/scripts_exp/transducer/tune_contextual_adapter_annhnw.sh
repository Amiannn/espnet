...
asr_config=conf/contextual/transducer/contextual_adapter_annhnw.yaml
inference_config=conf/contextual/transducer/decode_contextual_adapter_bs10.yaml
asr_tag=transducer/contextual_adapter_annhnw
...
pretrained_model=./exp/asr_transducer/contextual_adapter_suffix/valid.loss.ave_10best.pth
